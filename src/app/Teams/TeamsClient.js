...
export default function TeamsClient({ initialTeams, stats }) {
  ...
  }, [searchTerm, filterActive, initialTeams]);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {/* Publicité */}
      <AdBanner format="banner" className="max-w-7xl mx-auto px-4 py-4" />
